# Generated by Django 2.2.10 on 2021-11-06 05:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostname', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Host label')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Update time')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Comment')),
                ('assetexpansion', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='assets.AssetExpansion', verbose_name='assetexpansion')),
            ],
            options={
